...
PARAM$finalmodel$num_iterations <- 1809
PARAM$finalmodel$learning_rate <- 0.00802544800768134
PARAM$finalmodel$feature_fraction <- 0.819667747364698
PARAM$finalmodel$min_data_in_leaf <- 25
PARAM$finalmodel$num_leaves <- 777
PARAM$finalmodel$lambda_l1 <- 0
PARAM$finalmodel$lambda_l2 <- 29

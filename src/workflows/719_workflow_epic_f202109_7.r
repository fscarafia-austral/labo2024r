...
FErf_attributes_base <- function( pinputexps, ratio, desvio)
{
  ...
  param_local$train$training <- c( 202012, 202101, 202102, 202103)
...
TS_strategy_base9 <- function( pinputexps )
{
  ...
  param_local$final_train$training <- c(202107, 202106, 202104, 202102,
    202012, 202002, 202001, 201911, 201909, 201907, 201905, 201903, 201901)


  param_local$train$training <- c(202105, 202103, 202101,
    202011, 201912, 201910, 201908, 201906, 201904, 201902)
  param_local$train$validation <- c(202106, 202001)
  param_local$train$testing <- c(202107, 202002)

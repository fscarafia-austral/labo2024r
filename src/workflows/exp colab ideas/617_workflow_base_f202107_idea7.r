...
TS_strategy_base7 <- function( pinputexps )
{
  ...
  param_local$train$training <- c(202009, 202008, 202007,
    202002, 202001, 201912, 201911, 201910, 201909)
  param_local$train$validation <- c(202101, 202012, 202011, 202010)
  param_local$train$testing <- c(202105, 202104, 202103, 202102)
